...
function get_inv_details(inv_no)
	...
	$.post("http://megalaundry.aipsoft.com/qr_code_track.php", {track_invoice_no:inv_no },
			   function(data) {
...
<br>
			...
			<p style="color:#21A957; font-weight:bold">Welcome to Mega Laundry Service Tracker <?php echo $inv_no; ?></p>
		</div>
	</div>
</div>
  	<!----//End-header---->
...
<form><input type="text" name="inv" style="height:30px;" /><input type="submit" value="Get" style="height:34px;"  /></form></p>
             ...
             <!-- contianter qr -->
                        ...
                        <p>--------------------------------</p>
       					...
       					<p>Powered By <a href="http://itsmagnus.com/" style="color:#0000E5">MAGNUS</a></p>
